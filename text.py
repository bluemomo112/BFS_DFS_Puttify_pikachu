...
def drawText(mc, font, pos, forwardVec, upVec, text, foreground=None, forestyle=0, background=None, backstyle=0, align=ALIGN_LEFT, buffer=None):
    try:
    ...
    for line in lines:
        ...
        for value in line:
            try:
                ...
                glyph = font[32]
            pixelPos = drawGlyph(mc, pixelPos, forwardVec, upVec, glyph, foreground, forestyle, background, backstyle, buffer)
